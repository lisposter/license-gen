...
if(args.length <= 0) {
                ...
                if(licenses.length === 1) {
                    ...
                    prompt.get({
                        ...
                        if(test(result.value)) {
                            licenseGen(licenses[0], config, function(err, result) {
                    ...
                    prompt.get({
                        ...
                        licenseGen(result.value, config, function(err, result) {
                            if(err) console.error(err);
                            console.log('LICENSE has been generated!');
                        })
                    })
    ...
    async.waterfall([
        ...
        function(licenseType, config, callback) {
            licenseGen(licenseType, config, function(err, result) {
                if(err) console.error(err);
                console.log('LICENSE has been generated!');
            })
        }
